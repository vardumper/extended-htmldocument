...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:template match="item[@type='input']">
        <xsl:element name="input">
            ...
            <xsl:if test="fragment[@name='accept']">
                <xsl:attribute name="accept">
                    <xsl:value-of select="fragment[@name='accept']"/>
                </xsl:attribute>
            </xsl:if>
            ...
            <xsl:if test="fragment[@name='checked']">
                <xsl:attribute name="checked">
                    <xsl:value-of select="fragment[@name='checked']"/>
                </xsl:attribute>
            </xsl:if>
            ...
            <xsl:if test="fragment[@name='list']">
                <xsl:attribute name="list">
                    <xsl:value-of select="fragment[@name='list']"/>
                </xsl:attribute>
            </xsl:if>
            <xsl:if test="fragment[@name='max']">
                <xsl:attribute name="max">
                    <xsl:value-of select="fragment[@name='max']"/>
                </xsl:attribute>
            </xsl:if>
            ...
            <xsl:if test="fragment[@name='min']">
                <xsl:attribute name="min">
                    <xsl:value-of select="fragment[@name='min']"/>
                </xsl:attribute>
            </xsl:if>
            ...
            <xsl:if test="fragment[@name='pattern']">
                <xsl:attribute name="pattern">
                    <xsl:value-of select="fragment[@name='pattern']"/>
                </xsl:attribute>
            </xsl:if>
            ...
            <xsl:if test="fragment[@name='step']">
                <xsl:attribute name="step">
                    <xsl:value-of select="fragment[@name='step']"/>
                </xsl:attribute>
            </xsl:if>
            <xsl:if test="fragment[@name='type'] and contains('|button|checkbox|color|date|datetime-local|email|file|hidden|image|month|number|password|radio|range|reset|search|submit|tel|text|time|url|week|', concat('|', fragment[@name='type'], '|'))">
            ...
            <xsl:if test="fragment[@name='formenctype'] and contains('|application/x-www-form-urlencoded|multipart/form-data|text/plain|', concat('|', fragment[@name='formenctype'], '|'))">
                <xsl:attribute name="formenctype">
                    <xsl:value-of select="fragment[@name='formenctype']"/>
                </xsl:attribute>
            </xsl:if>
            <xsl:if test="fragment[@name='formmethod'] and contains('|get|post|dialog|', concat('|', fragment[@name='formmethod'], '|'))">
            ...
            <xsl:if test="fragment[@name='popovertargetaction'] and contains('|show|hide|toggle|', concat('|', fragment[@name='popovertargetaction'], '|'))">
            ...
            <xsl:if test="fragment[@name='ariaCurrent'] and contains('|false|page|step|location|date|time|true|', concat('|', fragment[@name='ariaCurrent'], '|'))">
            ...
            <xsl:if test="fragment[@name='ariaChecked'] and contains('|false|true|mixed|undefined|', concat('|', fragment[@name='ariaChecked'], '|'))">
            ...
            <xsl:if test="fragment[@name='ariaValuemax']">
                <xsl:attribute name="aria-valuemax">
                    <xsl:value-of select="fragment[@name='ariaValuemax']"/>
                </xsl:attribute>
            </xsl:if>
            <xsl:if test="fragment[@name='ariaValuemin']">
                <xsl:attribute name="aria-valuemin">
                    <xsl:value-of select="fragment[@name='ariaValuemin']"/>
                </xsl:attribute>
            </xsl:if>
            <xsl:if test="fragment[@name='ariaValuenow']">
                <xsl:attribute name="aria-valuenow">
                    <xsl:value-of select="fragment[@name='ariaValuenow']"/>
                </xsl:attribute>
            </xsl:if>
            <xsl:if test="fragment[@name='ariaValuetext']">
                <xsl:attribute name="aria-valuetext">
                    <xsl:value-of select="fragment[@name='ariaValuetext']"/>
                </xsl:attribute>
            </xsl:if>
