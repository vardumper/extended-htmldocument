...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:template match="item[@type='meter']">
        <xsl:element name="meter">
            <xsl:if test="@id">
            ...
            <xsl:if test="fragment[@name='high']">
                <xsl:attribute name="high">
                    <xsl:value-of select="fragment[@name='high']"/>
                </xsl:attribute>
            </xsl:if>
            <xsl:if test="fragment[@name='low']">
                <xsl:attribute name="low">
                    <xsl:value-of select="fragment[@name='low']"/>
                </xsl:attribute>
            </xsl:if>
            ...
            <xsl:if test="fragment[@name='optimum']">
                <xsl:attribute name="optimum">
                    <xsl:value-of select="fragment[@name='optimum']"/>
                </xsl:attribute>
            </xsl:if>
