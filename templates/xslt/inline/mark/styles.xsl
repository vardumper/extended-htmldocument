...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:template match="item[@type='mark']">
        <xsl:element name="mark">
            ...
            <xsl:apply-templates select="item[@type='area' or @type='audio' or @type='bdi' or @type='bdo' or @type='br' or @type='del' or @type='embed' or @type='form' or @type='iframe' or @type='img' or @type='ins' or @type='a' or @type='button' or @type='input' or @type='select' or @type='textarea' or @type='details' or @type='summary' or @type='map' or @type='object' or @type='param' or @type='picture' or @type='rp' or @type='rt' or @type='ruby' or @type='source' or @type='span' or @type='table' or @type='track' or @type='video' or @type='wbr']"/>
        </xsl:element>
    </xsl:template>
