...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:template match="item[@type='ol']">
        <xsl:element name="ol">
            <xsl:if test="@id">
            ...
            <xsl:if test="fragment[@name='reversed']">
                <xsl:attribute name="reversed">
                    <xsl:value-of select="fragment[@name='reversed']"/>
                </xsl:attribute>
            </xsl:if>
            <xsl:if test="fragment[@name='start']">
                <xsl:attribute name="start">
                    <xsl:value-of select="fragment[@name='start']"/>
                </xsl:attribute>
            </xsl:if>
            <xsl:if test="fragment[@name='type'] and contains('|a|A|i|I|1|', concat('|', fragment[@name='type'], '|'))">
            ...
            <xsl:apply-templates select="item[@type='li']"/>
        </xsl:element>
    </xsl:template>
