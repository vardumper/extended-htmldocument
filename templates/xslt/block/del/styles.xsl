...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:template match="item[@type='del']">
        <xsl:element name="del">
            ...
            <xsl:if test="fragment[@name='cite']">
                <xsl:attribute name="cite">
                    <xsl:value-of select="fragment[@name='cite']"/>
                </xsl:attribute>
            </xsl:if>
            <xsl:if test="fragment[@name='datetime']">
                <xsl:attribute name="datetime">
                    <xsl:value-of select="fragment[@name='datetime']"/>
                </xsl:attribute>
            </xsl:if>
