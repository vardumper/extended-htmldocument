...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:template match="item[@type='article']">
        <xsl:element name="article">
            ...
            <xsl:if test="fragment[@name='ariaOwns']">
                <xsl:attribute name="aria-owns">
                    <xsl:value-of select="fragment[@name='ariaOwns']"/>
                </xsl:attribute>
            </xsl:if>
            ...
            <xsl:apply-templates select="item[@type='a' or @type='abbr' or @type='area' or @type='article' or @type='audio' or @type='b' or @type='bdi' or @type='bdo' or @type='br' or @type='cite' or @type='code' or @type='data' or @type='del' or @type='dfn' or @type='div' or @type='dl' or @type='em' or @type='embed' or @type='figure' or @type='form' or @type='h1' or @type='h2' or @type='h3' or @type='h4' or @type='h5' or @type='h6' or @type='i' or @type='iframe' or @type='img' or @type='ins' or @type='kbd' or @type='map' or @type='mark' or @type='object' or @type='ol' or @type='p' or @type='picture' or @type='pre' or @type='q' or @type='ruby' or @type='s' or @type='samp' or @type='small' or @type='span' or @type='strong' or @type='sub' or @type='sup' or @type='table' or @type='time' or @type='u' or @type='ul' or @type='var' or @type='video' or @type='wbr']"/>
        </xsl:element>
    </xsl:template>
