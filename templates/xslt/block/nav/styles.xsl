...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:template match="item[@type='nav']">
        <xsl:element name="nav">
            ...
            <xsl:apply-templates select="item[@type='a' or @type='article' or @type='cite' or @type='em' or @type='q' or @type='s' or @type='small' or @type='strong']"/>
        </xsl:element>
    </xsl:template>
