...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:template match="item[@type='video']">
        <xsl:element name="video">
            ...
            <xsl:if test="fragment[@name='autoplay']">
                <xsl:attribute name="autoplay">
                    <xsl:value-of select="fragment[@name='autoplay']"/>
                </xsl:attribute>
            </xsl:if>
            <xsl:if test="fragment[@name='controls']">
                <xsl:attribute name="controls">
                    <xsl:value-of select="fragment[@name='controls']"/>
                </xsl:attribute>
            </xsl:if>
            ...
            <xsl:if test="fragment[@name='loop']">
                <xsl:attribute name="loop">
                    <xsl:value-of select="fragment[@name='loop']"/>
                </xsl:attribute>
            </xsl:if>
            <xsl:if test="fragment[@name='muted']">
                <xsl:attribute name="muted">
                    <xsl:value-of select="fragment[@name='muted']"/>
                </xsl:attribute>
            </xsl:if>
            <xsl:if test="fragment[@name='poster']">
                <xsl:attribute name="poster">
                    <xsl:value-of select="fragment[@name='poster']"/>
                </xsl:attribute>
            </xsl:if>
            <xsl:if test="fragment[@name='preload'] and contains('|auto|metadata|none|', concat('|', fragment[@name='preload'], '|'))">
                <xsl:attribute name="preload">
                    <xsl:value-of select="fragment[@name='preload']"/>
                </xsl:attribute>
            </xsl:if>
