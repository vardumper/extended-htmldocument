...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:template match="item[@type='details']">
        <xsl:element name="details">
            ...
            <xsl:apply-templates select="item[@type='div' or @type='dl' or @type='form' or @type='li' or @type='ol' or @type='p' or @type='pre' or @type='summary' or @type='table' or @type='ul']"/>
        </xsl:element>
    </xsl:template>
