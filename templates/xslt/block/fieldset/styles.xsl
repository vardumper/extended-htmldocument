...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:template match="item[@type='fieldset']">
        <xsl:element name="fieldset">
            ...
            <xsl:apply-templates select="item[@type='button' or @type='datalist' or @type='input' or @type='label' or @type='legend' or @type='meter' or @type='output' or @type='progress' or @type='select' or @type='textarea']"/>
        </xsl:element>
    </xsl:template>
