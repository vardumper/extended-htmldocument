...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:template match="item[@type='dialog']">
        <xsl:element name="dialog">
            ...
            <xsl:if test="fragment[@name='open']">
                <xsl:attribute name="open">
                    <xsl:value-of select="fragment[@name='open']"/>
                </xsl:attribute>
            </xsl:if>
            ...
            <xsl:if test="fragment[@name='ariaModal'] and contains('|false|true|', concat('|', fragment[@name='ariaModal'], '|'))">
                <xsl:attribute name="aria-modal">
                    <xsl:value-of select="fragment[@name='ariaModal']"/>
                </xsl:attribute>
            </xsl:if>
            ...
            <xsl:apply-templates select="item[@type='button' or @type='div' or @type='dl' or @type='form' or @type='h1' or @type='h2' or @type='h3' or @type='h4' or @type='h5' or @type='h6' or @type='a' or @type='input' or @type='select' or @type='textarea' or @type='details' or @type='summary' or @type='iframe' or @type='li' or @type='ol' or @type='p' or @type='pre' or @type='table' or @type='ul']"/>
        </xsl:element>
    </xsl:template>
