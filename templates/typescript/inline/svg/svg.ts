...
export interface SvgProps {
   ...
   */
  'view-box'?: string | null | undefined;
  /**
...
export class Svg {
  ...
  private applyProps(props: SvgProps): void {
  ...
  setFill(value: string | null | undefined): this {
    if (value === null || value === undefined) {
  ...
  setStroke(value: string | null | undefined): this {
    if (value === null || value === undefined) {
  ...
  setViewBox(value: string | null | undefined): this {
    if (value === null || value === undefined) {
  ...
  setXmlns(value: string | null | undefined): this {
    if (value === null || value === undefined) {
