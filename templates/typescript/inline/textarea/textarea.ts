...
export interface TextareaProps {
   ...
   */
  'aria-multiline'?: string | boolean | null | undefined;
  /**
   ...
   * 
   */
  wrap?: string | boolean | null | undefined;
}
...
export class Textarea {
  ...
  setAriaMultiline(value: string | boolean | null | undefined): this {
    if (value === null || value === undefined) {
  ...
  setWrap(value: string | boolean | null | undefined): this {
    if (value === null || value === undefined) {
