...
export interface SelectProps {
   ...
   */
  'aria-multiselectable'?: string | boolean | null | undefined;
  /**
   * Specifies whether an element is horizontal or vertical.
   */
  'aria-orientation'?: string | boolean | null | undefined;
  /**
...
export class Select {
  ...
  setAriaMultiselectable(value: string | boolean | null | undefined): this {
    if (value === null || value === undefined) {
  ...
  setAriaOrientation(value: string | boolean | null | undefined): this {
    if (value === null || value === undefined) {
