...
export interface AProps {
   ...
   */
  target?: string | boolean | null | undefined | string;
  /**
...
export class A {
  ...
  setRel(value: string | boolean | null | undefined): this {
    if (value === null || value === undefined) {
  ...
  setTarget(value: string | boolean | null | undefined | string): this {
    if (value === true) {
      this.element.setAttribute('target', '');
    } else {
