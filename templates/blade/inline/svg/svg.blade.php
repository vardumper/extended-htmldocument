...
<svg
  ...
  @if(isset($fill) && is_bool($fill) && $fill) fill @elseif(isset($fill) && $fill) fill="{{ $fill }}" @endif
  ...
  @if(isset($stroke) && is_bool($stroke) && $stroke) stroke @elseif(isset($stroke) && $stroke) stroke="{{ $stroke }}" @endif
  ...
  @if(isset($viewBox) && is_bool($viewBox) && $viewBox) view-box @elseif(isset($viewBox) && $viewBox) view-box="{{ $viewBox }}" @endif
  @if(isset($width) && is_bool($width) && $width) width @elseif(isset($width) && $width) width="{{ $width }}" @endif
  @if(isset($xmlns) && is_bool($xmlns) && $xmlns) xmlns @elseif(isset($xmlns) && $xmlns) xmlns="{{ $xmlns }}" @endif>
  @yield('content')
</svg>
@endsection
