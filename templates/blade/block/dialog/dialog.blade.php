...
<dialog
  ...
  @if(isset($ariaModal) && is_bool($ariaModal) && $ariaModal) aria-modal @elseif(isset($ariaModal) && $ariaModal) aria-modal="{{ $ariaModal }}" @endif
  ...
  @if(isset($open) && is_bool($open) && $open) open @elseif(isset($open) && $open) open="{{ $open }}" @endif
