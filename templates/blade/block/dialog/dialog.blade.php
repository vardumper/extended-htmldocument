...
$ariaModalChoices = ['false' => true, 'true' => true];
...
if (isset($ariaModal) && isset($ariaModalChoices[$ariaModal])) $attrs[] = 'aria-modal="' . e($ariaModal) . '"';
...
if (isset($open)) $attrs[] = 'open="' . e($open) . '"';
