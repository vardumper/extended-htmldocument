...
<ol
  ...
  @if(isset($reversed) && is_bool($reversed) && $reversed) reversed @elseif(isset($reversed) && $reversed) reversed="{{ $reversed }}" @endif
  ...
  @if(isset($start) && is_bool($start) && $start) start @elseif(isset($start) && $start) start="{{ $start }}" @endif
