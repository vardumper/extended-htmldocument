...
<option
  ...
  @if(isset($ariaLevel) && is_bool($ariaLevel) && $ariaLevel) aria-level @elseif(isset($ariaLevel) && $ariaLevel) aria-level="{{ $ariaLevel }}" @endif
  @if(isset($ariaLive) && is_bool($ariaLive) && $ariaLive) aria-live @elseif(isset($ariaLive) && $ariaLive) aria-live="{{ $ariaLive }}" @endif
  @if(isset($ariaPosinset) && is_bool($ariaPosinset) && $ariaPosinset) aria-posinset @elseif(isset($ariaPosinset) && $ariaPosinset) aria-posinset="{{ $ariaPosinset }}" @endif
  ...
  @if(isset($ariaSelected) && is_bool($ariaSelected) && $ariaSelected) aria-selected @elseif(isset($ariaSelected) && $ariaSelected) aria-selected="{{ $ariaSelected }}" @endif
  @if(isset($ariaSetsize) && is_bool($ariaSetsize) && $ariaSetsize) aria-setsize @elseif(isset($ariaSetsize) && $ariaSetsize) aria-setsize="{{ $ariaSetsize }}" @endif
  ...
  @if(isset($selected) && is_bool($selected) && $selected) selected @elseif(isset($selected) && $selected) selected="{{ $selected }}" @endif
