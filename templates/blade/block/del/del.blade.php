...
<del
  ...
  @if(isset($cite) && is_bool($cite) && $cite) cite @elseif(isset($cite) && $cite) cite="{{ $cite }}" @endif
  ...
  @if(isset($datetime) && is_bool($datetime) && $datetime) datetime @elseif(isset($datetime) && $datetime) datetime="{{ $datetime }}" @endif
