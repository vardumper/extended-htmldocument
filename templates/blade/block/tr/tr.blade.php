...
--}}
@php
$alignChoices = ['left' => true, 'center' => true, 'right' => true, 'justify' => true, 'char' => true];
$valignChoices = ['baseline' => true, 'bottom' => true, 'middle' => true, 'top' => true];
...
$ariaSelectedChoices = ['false' => true, 'true' => true, 'undefined' => true];
...
if (isset($ariaLevel)) $attrs[] = 'aria-level="' . e($ariaLevel) . '"';
if (isset($ariaLive) && isset($ariaLiveChoices[$ariaLive])) $attrs[] = 'aria-live="' . e($ariaLive) . '"';
if (isset($ariaPosinset)) $attrs[] = 'aria-posinset="' . e($ariaPosinset) . '"';
...
if (isset($ariaSelected) && isset($ariaSelectedChoices[$ariaSelected])) $attrs[] = 'aria-selected="' . e($ariaSelected) . '"';
if (isset($ariaSetsize)) $attrs[] = 'aria-setsize="' . e($ariaSetsize) . '"';
...
if (isset($bgcolor)) $attrs[] = 'bgcolor="' . e($bgcolor) . '"';
if (isset($char)) $attrs[] = 'char="' . e($char) . '"';
if (isset($charoff)) $attrs[] = 'charoff="' . e($charoff) . '"';
...
if (isset($valign) && isset($valignChoices[$valign])) $attrs[] = 'valign="' . e($valign) . '"';
@endphp
@section('tr')
<tr {!! implode(' ', $attrs) !!}>
  @yield('content')
