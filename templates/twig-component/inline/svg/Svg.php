...
class Svg
{
    ...
    public function preMount(array $data): array
    {
        ...
        $resolver->setAllowedTypes('xmlns', ['null', 'string']);
        $resolver->setAllowedTypes('viewBox', ['null', 'string']);
        $resolver->setAllowedTypes('stroke', ['null', 'string']);
        $resolver->setAllowedTypes('fill', ['null', 'string']);
