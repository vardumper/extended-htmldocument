...
class Ol
{
    ...
    public ?Html\Enum\OlTypeEnum $type = null;
    ...
    public ?Html\Enum\AriaMultiselectableEnum $ariaMultiselectable = null;
    public ?string $ariaActivedescendant = null;
    public ?Html\Enum\AriaOrientationEnum $ariaOrientation = null;
    ...
    public function preMount(array $data): array
    {
        ...
        $resolver->setAllowedTypes('reversed', ['null', 'string']);
        $resolver->setAllowedTypes('start', ['null', 'string']);
        $resolver->setAllowedTypes('type', ['null', 'string', OlTypeEnum::class]);
        $resolver->setNormalizer('type', function ($options, $value) {
            if (is_string($value)) {
                return OlTypeEnum::tryFrom($value);
            }
            return $value;
        });
        ...
        $resolver->setAllowedTypes('ariaActivedescendant', ['null', 'string']);
        ...
        $resolver->setAllowedTypes('ariaOwns', ['null', 'string']);
