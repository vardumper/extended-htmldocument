...
/**
 * Table Header - The th element represents a header cell in a table.
 *
...
class Th
{
    ...
    public ?Html\Enum\AriaSortEnum $ariaSort = null;
    public ?int $ariaColindex = null;
    public ?int $ariaColspan = null;
    public ?int $ariaRowindex = null;
    public ?int $ariaRowspan = null;
    ...
    public function preMount(array $data): array
    {
        ...
        $resolver->setAllowedTypes('colspan', ['null', 'string']);
        $resolver->setAllowedTypes('headers', ['null', 'string']);
        $resolver->setAllowedTypes('rowspan', ['null', 'string']);
        $resolver->setAllowedTypes('scope', ['null', 'string']);
        ...
        $resolver->setAllowedTypes('ariaColcount', ['null', 'string']);
        $resolver->setAllowedTypes('ariaRowcount', ['null', 'string']);
        $resolver->setAllowedTypes('ariaSort', ['null', 'string', AriaSortEnum::class]);
        $resolver->setNormalizer('ariaSort', function ($options, $value) {
            if (is_string($value)) {
                return AriaSortEnum::tryFrom($value);
            }
            return $value;
        });
        $resolver->setAllowedTypes('ariaColindex', ['null', 'string']);
        $resolver->setAllowedTypes('ariaColspan', ['null', 'string']);
        $resolver->setAllowedTypes('ariaRowindex', ['null', 'string']);
        $resolver->setAllowedTypes('ariaRowspan', ['null', 'string']);
