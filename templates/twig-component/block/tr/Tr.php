...
class Tr
{
    public ?Html\Enum\TrAlignEnum $align = null;
    public ?string $bgcolor = null;
    public ?string $char = null;
    public ?string $charoff = null;
    public ?Html\Enum\ValignEnum $valign = null;
    ...
    public ?Html\Enum\AriaSelectedEnum $ariaSelected = null;
    ...
    public function preMount(array $data): array
    {
        ...
        $resolver->setNormalizer('align', function ($options, $value) {
            if (is_string($value)) {
                return TrAlignEnum::tryFrom($value);
            }
            return $value;
        });
        $resolver->setAllowedTypes('bgcolor', ['null', 'string']);
        $resolver->setAllowedTypes('char', ['null', 'string']);
        $resolver->setAllowedTypes('charoff', ['null', 'string']);
        $resolver->setAllowedTypes('valign', ['null', 'string', ValignEnum::class]);
        $resolver->setNormalizer('valign', function ($options, $value) {
            if (is_string($value)) {
                return ValignEnum::tryFrom($value);
            }
            return $value;
        });
        ...
        $resolver->setNormalizer('ariaSelected', function ($options, $value) {
            if (is_string($value)) {
                return AriaSelectedEnum::tryFrom($value);
            }
            return $value;
        });
        $resolver->setAllowedTypes('ariaPosinset', ['null', 'string']);
        $resolver->setAllowedTypes('ariaSetsize', ['null', 'string']);
        $resolver->setAllowedTypes('ariaLevel', ['null', 'string']);
