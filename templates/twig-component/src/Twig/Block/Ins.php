...
/**
 * Inserted Text - The ins element represents an addition to the document.
 *
 * @author vardumper <info@erikpoehler.com>
 * @package Html\TwigComponentBundle
 * @see https://github.com/vardumper/extended-htmldocument
 */
#[AsTwigComponent('Ins', template: '@HtmlTwigComponent/block/ins/ins.html.twig')]
class Ins
{
    ...
    public function preMount(array $data): array
    {
        ...
        $resolver->setAllowedTypes('cite', ['string']);
        $resolver->setAllowedTypes('datetime', ['string']);
