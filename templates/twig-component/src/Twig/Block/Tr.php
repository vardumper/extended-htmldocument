...
class Tr
{
    ...
    public function preMount(array $data): array
    {
        ...
        $resolver->setAllowedTypes('bgcolor', ['string']);
        ...
        $resolver->setAllowedTypes('ariaPosinset', ['int']);
        $resolver->setAllowedTypes('ariaSetsize', ['int']);
        $resolver->setAllowedTypes('ariaLevel', ['int']);
