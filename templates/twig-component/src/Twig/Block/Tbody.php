...
/**
 * Table Body - The tbody element groups one or more tr elements as the body of a table.
 *
 * @author vardumper <info@erikpoehler.com>
 * @package Html\TwigComponentBundle
 * @see https://github.com/vardumper/extended-htmldocument
 */
#[AsTwigComponent('Tbody', template: '@HtmlTwigComponent/block/tbody/tbody.html.twig')]
class Tbody
{
