 ...
 */
#[AsTwigComponent('Svg', template: '@HtmlTwigComponent/inline/svg/svg.html.twig')]
class Svg
{
    ...
    public function preMount(array $data): array
    {
        ...
        $resolver->setAllowedTypes('xmlns', ['string']);
        $resolver->setAllowedTypes('viewBox', ['string']);
        $resolver->setAllowedTypes('stroke', ['string']);
        $resolver->setAllowedTypes('fill', ['string']);
