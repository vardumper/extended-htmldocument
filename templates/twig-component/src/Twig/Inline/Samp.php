...
/**
 * Sample Output - The samp element represents sample (or quoted) output from a computer program.
 *
 * @author vardumper <info@erikpoehler.com>
 * @package Html\TwigComponentBundle
 * @see https://github.com/vardumper/extended-htmldocument
 */
#[AsTwigComponent('Samp', template: '@HtmlTwigComponent/inline/samp/samp.html.twig')]
class Samp
{
