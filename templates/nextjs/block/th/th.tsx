 ...
 *
 * @generated November 9, 2025 19:18:05
...
export const Th: React.FC<ThProps> = (props: ThProps) => {
  ...
  if (ariaColindex !== undefined) {
    elementProps['aria-colindex'] = ariaColindex;
  }

  if (ariaColspan !== undefined) {
    elementProps['aria-colspan'] = ariaColspan;
  }
  ...
  if (ariaRowindex !== undefined) {
    elementProps['aria-rowindex'] = ariaRowindex;
  }

  if (ariaRowspan !== undefined) {
    elementProps['aria-rowspan'] = ariaRowspan;
  }
