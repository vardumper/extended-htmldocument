...
/**
 * svg entity — persists as XML via DOM-ORM.
 */
#[ORM\Item(entityType: 'svg')]
class ScalableVectorGraphicsEntity extends AbstractEntity
{
    /**
     * Allowed parent elements (HTML content model)
     * @var array<string>
     */
    public static array $childOf = ['svg'];

    /**
     * Allowed child elements (HTML content model)
     * @var array<string>
     */
    public static array $parentOf = ['a', 'script', 'style', 'svg', 'title'];
    ...
    public function setXmlns(?string $value): static
    {
        $this->xmlns = $value;
        return $this;
    }
    ...
    public function setViewBox(?string $value): static
    {
        $this->viewBox = $value;
        return $this;
    }
    ...
    public function setStroke(?string $value): static
    {
        $this->stroke = $value;
        return $this;
    }
    ...
    public function setFill(?string $value): static
    {
        $this->fill = $value;
        return $this;
    }
