...
/**
 * rp entity — persists as XML via DOM-ORM.
 */
#[ORM\Item(entityType: 'rp')]
class RubyParenthesisEntity extends AbstractEntity
{
    /**
     * Allowed parent elements (HTML content model)
     * @var array<string>
     */
    public static array $childOf = ['aside', 'dd', 'div', 'footer', 'header', 'main', 'mark', 'ruby', 'section'];
