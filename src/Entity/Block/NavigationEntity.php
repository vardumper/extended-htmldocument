...
/**
 * nav entity — persists as XML via DOM-ORM.
 */
#[ORM\Item(entityType: 'nav')]
class NavigationEntity extends AbstractEntity
{
    /**
     ...
     * @var array<string>
     */
    public static array $parentOf = ['a', 'article', 'cite', 'em', 'q', 's', 'small', 'strong'];
