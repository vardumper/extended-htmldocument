...
/**
 * blockquote entity — persists as XML via DOM-ORM.
 */
#[ORM\Item(entityType: 'blockquote')]
class BlockquoteEntity extends AbstractEntity
{
    /**
     ...
     * @var array<string>
     */
    public static array $parentOf = ['article', 'p'];
