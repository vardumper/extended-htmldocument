...
/**
 * details entity — persists as XML via DOM-ORM.
 */
#[ORM\Item(entityType: 'details')]
class DetailsEntity extends AbstractEntity
{
    /**
     ...
     * @var array<string>
     */
    public static array $parentOf = ['div', 'dl', 'form', 'li', 'ol', 'p', 'pre', 'summary', 'table', 'ul'];
