...
/**
 * section entity — persists as XML via DOM-ORM.
 */
#[ORM\Item(entityType: 'section')]
class SectionEntity extends AbstractEntity
{
    /**
     * Allowed parent elements (HTML content model)
     * @var array<string>
     */
    public static array $childOf = ['body', 'div', 'main', 'p'];
