...
/**
 * figcaption entity — persists as XML via DOM-ORM.
 */
#[ORM\Item(entityType: 'figcaption')]
class FigureCaptionEntity extends AbstractEntity
{
    /**
     * Allowed parent elements (HTML content model)
     * @var array<string>
     */
    public static array $childOf = ['figure', 'aside', 'footer', 'header', 'section'];
