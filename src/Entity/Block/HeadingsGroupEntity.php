...
/**
 * hgroup entity — persists as XML via DOM-ORM.
 */
#[ORM\Item(entityType: 'hgroup')]
class HeadingsGroupEntity extends AbstractEntity
{
    /**
     ...
     * @var array<string>
     */
    public static array $parentOf = ['h1', 'h2', 'h3', 'h4', 'h5', 'h6'];
