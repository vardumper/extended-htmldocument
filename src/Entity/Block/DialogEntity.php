...
/**
 * dialog entity — persists as XML via DOM-ORM.
 */
#[ORM\Item(entityType: 'dialog')]
class DialogEntity extends AbstractEntity
{
    /**
     * Allowed parent elements (HTML content model)
     * @var array<string>
     */
    public static array $childOf = ['body', 'form'];
    ...
    public function __construct(
        ...
        #[ORM\Fragment]
        protected ?string $ariaModal = null,
        #[ORM\Fragment]
    ...
    public function setAriaModal(?string $value): static
    {
        $this->ariaModal = $value;
        return $this;
    }

    public function getAriaModal(): ?string
    {
