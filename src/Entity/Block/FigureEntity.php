...
/**
 * figure entity — persists as XML via DOM-ORM.
 */
#[ORM\Item(entityType: 'figure')]
class FigureEntity extends AbstractEntity
{
    /**
     ...
     * @var array<string>
     */
    public static array $parentOf = ['figcaption', 'img'];
