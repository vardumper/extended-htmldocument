...
/**
 * optgroup entity — persists as XML via DOM-ORM.
 */
#[ORM\Item(entityType: 'optgroup')]
class OptionGroupEntity extends AbstractEntity
{
    /**
     * Allowed parent elements (HTML content model)
     * @var array<string>
     */
    public static array $childOf = ['select'];
