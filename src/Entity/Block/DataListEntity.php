...
/**
 * datalist entity — persists as XML via DOM-ORM.
 */
#[ORM\Item(entityType: 'datalist')]
class DataListEntity extends AbstractEntity
{
    /**
     * Allowed parent elements (HTML content model)
     * @var array<string>
     */
    public static array $childOf = ['body', 'fieldset', 'form'];

    /**
     * Allowed child elements (HTML content model)
     * @var array<string>
     */
    public static array $parentOf = ['option'];
