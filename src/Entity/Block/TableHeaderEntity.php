...
/**
 * th entity — persists as XML via DOM-ORM.
 */
#[ORM\Item(entityType: 'th')]
class TableHeaderEntity extends AbstractEntity
{
    /**
     * Allowed parent elements (HTML content model)
     * @var array<string>
     */
    public static array $childOf = ['tr'];
    ...
    public function __construct(
        ...
        #[ORM\Fragment]
        protected ?string $ariaColspan = null,
        #[ORM\Fragment]
        protected ?string $ariaRowindex = null,
        #[ORM\Fragment]
        protected ?string $ariaRowspan = null,
        #[ORM\Fragment]
    ...
    public function setAriaColindex(?string $value): static
    {
        $this->ariaColindex = $value;
        return $this;
    }

    public function getAriaColindex(): ?string
    {
        return $this->ariaColindex;
    }

    public function setAriaColspan(?string $value): static
    {
        $this->ariaColspan = $value;
        return $this;
    }

    public function getAriaColspan(): ?string
    {
        return $this->ariaColspan;
    }

    public function setAriaRowindex(?string $value): static
    {
        $this->ariaRowindex = $value;
        return $this;
    }

    public function getAriaRowindex(): ?string
    {
        return $this->ariaRowindex;
    }

    public function setAriaRowspan(?string $value): static
    {
        $this->ariaRowspan = $value;
        return $this;
    }

    public function getAriaRowspan(): ?string
    {
