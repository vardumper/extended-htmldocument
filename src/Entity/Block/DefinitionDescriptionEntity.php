...
/**
 * dd entity — persists as XML via DOM-ORM.
 */
#[ORM\Item(entityType: 'dd')]
class DefinitionDescriptionEntity extends AbstractEntity
{
    /**
     * Allowed parent elements (HTML content model)
     * @var array<string>
     */
    public static array $childOf = ['dl', 'aside', 'dd', 'div', 'footer', 'header', 'main', 'section'];
