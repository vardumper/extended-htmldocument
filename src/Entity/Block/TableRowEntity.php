...
/**
 * tr entity — persists as XML via DOM-ORM.
 */
#[ORM\Item(entityType: 'tr')]
class TableRowEntity extends AbstractEntity
{
    /**
     * Allowed parent elements (HTML content model)
     * @var array<string>
     */
    public static array $childOf = ['table', 'thead', 'tbody', 'tfoot'];

    /**
     * Allowed child elements (HTML content model)
     * @var array<string>
     */
    public static array $parentOf = ['td', 'th'];
    ...
    public function __construct(
        ...
        #[ORM\Fragment]
        protected ?string $ariaSelected = null,
        #[ORM\Fragment]
        protected ?string $ariaPosinset = null,
        #[ORM\Fragment]
        protected ?string $ariaSetsize = null,
        #[ORM\Fragment]
        protected ?string $ariaLevel = null,
        #[ORM\Fragment]
    ...
    public function setChar(?string $value): static
    {
        $this->char = $value;
        return $this;
    }
    ...
    public function setCharoff(?string $value): static
    {
        $this->charoff = $value;
        return $this;
    }
    ...
    public function setValign(?string $value): static
    {
        $this->valign = $value;
        return $this;
    }
    ...
    public function setAriaSelected(?string $value): static
    {
        $this->ariaSelected = $value;
        return $this;
    }

    public function getAriaSelected(): ?string
    {
        return $this->ariaSelected;
    }

    public function setAriaPosinset(?string $value): static
    {
        $this->ariaPosinset = $value;
        return $this;
    }

    public function getAriaPosinset(): ?string
    {
        return $this->ariaPosinset;
    }

    public function setAriaSetsize(?string $value): static
    {
        $this->ariaSetsize = $value;
        return $this;
    }

    public function getAriaSetsize(): ?string
    {
        return $this->ariaSetsize;
    }

    public function setAriaLevel(?string $value): static
    {
        $this->ariaLevel = $value;
        return $this;
    }
    ...
    public function setAriaColcount(?string $value): static
    {
        $this->ariaColcount = $value;
        return $this;
    }

    public function getAriaColcount(): ?string
    {
        return $this->ariaColcount;
    }

    public function setAriaRowcount(?string $value): static
    {
        $this->ariaRowcount = $value;
        return $this;
    }

    public function getAriaRowcount(): ?string
    {
