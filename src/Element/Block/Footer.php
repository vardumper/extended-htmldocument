...
/**
 * The footer element represents a container for the bottom section of a document or a section, typically containing information about the author, copyright information, and links to related documents.
 */
#[Element('footer')]
class Footer extends BlockElement
{
     ...
     */
    public const string QUALIFIED_NAME = 'footer';
