// templates/typescript/block/dialog/dialog.ts
var Dialog = class {
  constructor(props = {}) {
  ...
  applyProps(props) {
    ...
    if (props["aria-modal"] !== void 0) {
      this.setAriaModal(props["aria-modal"]);
    }
    ...
    if (props.open !== void 0) {
      this.element.setAttribute("open", String(props.open));
    }
  ...
  setAriaModal(value) {
    if (value === null || value === void 0) {
      ...
      this.element.setAttribute("aria-modal", String(value));
    }
    return this;
  }
