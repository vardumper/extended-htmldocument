// templates/typescript/block/th/th.ts
var Th = class {
  constructor(props = {}) {
  ...
  applyProps(props) {
    ...
    if (props.scope !== void 0) {
      this.element.setAttribute("scope", String(props.scope));
    }
  ...
  setScope(value) {
    if (value === null || value === void 0) {
      this.element.removeAttribute("scope");
    } else {
      this.element.setAttribute("scope", String(value));
    }
    return this;
  }
  setSlot(value) {
