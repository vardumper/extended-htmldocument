// templates/typescript/block/ol/ol.ts
var Ol = class {
  constructor(props = {}) {
  ...
  applyProps(props) {
    ...
    if (props.reversed !== void 0) {
      this.element.setAttribute("reversed", String(props.reversed));
    }
    ...
    if (props.start !== void 0) {
      this.element.setAttribute("start", String(props.start));
    }
  ...
  setReversed(value) {
    if (value === true) {
      this.element.setAttribute("reversed", "");
    } else {
      this.element.removeAttribute("reversed");
    }
    return this;
  }
  setRole(value) {
  ...
  setStart(value) {
    if (value === null || value === void 0) {
      ...
      this.element.setAttribute("start", String(value));
    }
    return this;
  }
  setStyle(value) {
