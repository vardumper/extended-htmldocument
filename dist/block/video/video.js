// templates/typescript/block/video/video.ts
var Video = class {
  constructor(props = {}) {
  ...
  applyProps(props) {
    ...
    if (props.poster !== void 0) {
      this.element.setAttribute("poster", String(props.poster));
    }
  ...
  setPoster(value) {
    if (value === null || value === void 0) {
      ...
      this.element.setAttribute("poster", String(value));
    }
    return this;
  }
  setPreload(value) {
