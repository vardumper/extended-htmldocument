// templates/typescript/block/tr/tr.ts
var Tr = class {
  constructor(props = {}) {
  ...
  applyProps(props) {
    ...
    if (props["aria-selected"] !== void 0) {
      this.setAriaSelected(props["aria-selected"]);
    }
    if (props["aria-setsize"] !== void 0) {
