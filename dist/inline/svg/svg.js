// templates/typescript/inline/svg/svg.ts
var Svg = class {
  constructor(props = {}) {
  ...
  applyProps(props) {
    ...
    if (props.fill !== void 0) {
      this.element.setAttribute("fill", String(props.fill));
    }
    ...
    if (props.stroke !== void 0) {
      this.element.setAttribute("stroke", String(props.stroke));
    }
    ...
    if (props["view-box"] !== void 0) {
      this.element.setAttribute("view-box", String(props["view-box"]));
    }
    if (props.width !== void 0) {
      this.element.setAttribute("width", String(props.width));
    }
    if (props.xmlns !== void 0) {
      this.element.setAttribute("xmlns", String(props.xmlns));
    }
  }
  setAccessKey(value) {
  ...
  setFill(value) {
    if (value === null || value === void 0) {
      ...
      this.element.setAttribute("fill", String(value));
    }
    return this;
  }
  setHeight(value) {
  ...
  setStroke(value) {
    if (value === null || value === void 0) {
      ...
      this.element.setAttribute("stroke", String(value));
    }
    return this;
  }
  setStyle(value) {
  ...
  setViewBox(value) {
    if (value === null || value === void 0) {
      this.element.removeAttribute("view-box");
    } else {
      this.element.setAttribute("view-box", String(value));
    }
    return this;
  }
  setWidth(value) {
  ...
  setXmlns(value) {
    if (value === null || value === void 0) {
      ...
      this.element.setAttribute("xmlns", String(value));
    }
    return this;
  }
